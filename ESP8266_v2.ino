...
"<img src='http://www.missiongeek.net/wp-content/uploads/2015/12/cinemagraphs-darth-vader.gif'>"
"<form action='msg'><p>What's up? <input type='text' name='msg' size=50 autofocus> <input type='submit' value='Submit'></form>"
"</center>";
